...
app.use(cors({
  origin: ["http://localhost:3001","http://localhost:3000"],   // only allow frontend
  methods: ["GET", "POST", "PUT", "DELETE"],
  credentials: true
}));
...
const productRoutes = require('./routes/product');
const categoryRoutes = require('./routes/category');
const subCatRoutes = require('./routes/subCategoryRoutes'); // ✅ correct filename

// 5. Use routes
app.use('/api/products', productRoutes);
app.use('/api/categories', categoryRoutes);
app.use("/api/subCat", subCatRoutes); // ✅ use imported route
