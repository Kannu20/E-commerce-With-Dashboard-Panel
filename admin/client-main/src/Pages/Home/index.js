...
const closeProductModel = () => {
  ...
  useEffect(() => {
    fetchDataFromApi("/api/categories").then((res) => {
      console.log("Categories API Response 👉", res); // Confirm the shape
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-9 productRow">
              ...
              {/* Corrected Swiper block: use featuredProducts from API */}
              <Swiper
                slidesPerView={4}
                spaceBetween={25}
                navigation={true}
              ...
              {/* Optionally, add a NEW PRODUCTS Swiper here if you want */}
              {/* Banners */}
